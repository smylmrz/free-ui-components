...
export const previewCode = `${openTag('div')} ${attributeWithValues('class', 'space-y-10')}${closer()}
  ${openTag('div')} ${attributeWithValues('class', 'rounded-md bg-amber-50 p-5')}${closer()}
    ...
    ${closeTag('div')}
    ${openTag('div')} ${attributeWithValues('class', 'pl-6 text-orange-900 space-y-4')}${closer()}
      ${openTag('p')} ${attributeWithValues('class', 'text-sm')}${closer()}${dummyText}${closeTag('p')}
      ${openTag('div')} ${attributeWithValues('class', 'flex gap-5 font-medium')}${closer()}
        ${openTag('a')} ${attributeWithValues('href', '')}View${closeTag('a')}
        ${openTag('a')} ${attributeWithValues('href', '')}Dismiss${closeTag('a')}
       ${closeTag('div')}
      ${closeTag('div')}
    ${closeTag('div')}
  ${closeTag('div')}
  ...
  ${openTag('div')} ${attributeWithValues('class', 'rounded-md bg-green-50 p-5')}${closer()}
    ...
    ${closeTag('div')}
    ${openTag('div')} ${attributeWithValues('class', 'pl-6 text-green-700 space-y-4')}${closer()}
      ${openTag('p')} ${attributeWithValues('class', 'text-sm')}${closer()}${dummyText}${closeTag('p')}
      ${openTag('div')} ${attributeWithValues('class', 'flex gap-5 font-medium')}${closer()}
        ${openTag('a')} ${attributeWithValues('href', '')}View${closeTag('a')}
        ${openTag('a')} ${attributeWithValues('href', '')}Dismiss${closeTag('a')}
  ...
  ${openTag('div')} ${attributeWithValues('class', 'rounded-md bg-red-50 p-5')}${closer()}
    ...
    ${closeTag('div')}
    ${openTag('div')} ${attributeWithValues('class', 'pl-6 text-red-700 space-y-4')}${closer()}
      ${openTag('p')} ${attributeWithValues('class', 'text-sm')}${closer()}${dummyText}${closeTag('p')}
      ${openTag('div')} ${attributeWithValues('class', 'flex gap-5 font-medium')}${closer()}
        ${openTag('a')} ${attributeWithValues('href', '')}View${closeTag('a')}
        ${openTag('a')} ${attributeWithValues('href', '')}Dismiss${closeTag('a')}
